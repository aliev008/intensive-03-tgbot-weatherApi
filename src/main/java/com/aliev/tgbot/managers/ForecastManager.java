...
public class ForecastManager {
        ...
        return SendMessage.builder()
                .text(
                        """
                                ...
                                нажав на кнопку "Название Города".
                                """
                )
    ...
    private BotApiMethod<?> cityEntered(CallbackQuery query, String cityName, TgBot bot) {
    ...
    private BotApiMethod<?> cityEntering(CallbackQuery query, String current, TgBot bot) {
        return EditMessageText.builder()
    ...
    private BotApiMethod<?> mainMenu(CallbackQuery query, TgBot bot) {
        System.out.println("INSIDE ForecastManager mainMenu");
        return EditMessageText.builder()
                .text(
                        """
                                2 - Отправьте название города,
                                нажав на кнопку "Название Города".
                                """
                )
                .chatId(query.getMessage().getChatId())
